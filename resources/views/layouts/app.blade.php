    ...
    <header class="fixed w-full top-0 z-50 bg-white shadow-lg">
        <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
            ...
            <div class="hidden md:flex space-x-8 items-center">
                <a href="{{ route('home') }}#hero" class="hover:text-[#d6873f] transition font-medium">{{ __('nav.home') }}</a>
                <a href="{{ route('home') }}#about" class="hover:text-[#d6873f] transition font-medium">{{ __('nav.about') }}</a>
                <a href="{{ route('home') }}#gallery" class="hover:text-[#d6873f] transition font-medium">{{ __('nav.gallery') }}</a>
                <a href="{{ route('home') }}#amenities" class="hover:text-[#d6873f] transition font-medium">{{ __('nav.amenities') }}</a>
                <a href="{{ route('home') }}#location" class="hover:text-[#d6873f] transition font-medium">{{ __('nav.location') }}</a>
                ...
                <div class="flex space-x-2 pl-4">
                   <select onchange="window.location.href=this.value" class="border-none bg-gray-300 rounded-0 px-3 py-2">
                    ...
                    <a href="{{ route('admin.login') }}" class="hidden md:inline-block bg-[#d6873f] text-white px-6 py-2 rounded-0 hover:bg-amber-700 transition font-medium">
                        {{ __('nav.admin') }}
                    </a>
                </div>
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-white border-t">
            <div class="px-4 py-4 space-y-4">
                <a href="{{ route('home') }}#hero" class="block hover:text-[#d6873f] font-medium">{{ __('nav.home') }}</a>
                <a href="{{ route('home') }}#about" class="block hover:text-[#d6873f] font-medium">{{ __('nav.about') }}</a>
                <a href="{{ route('home') }}#gallery" class="block hover:text-[#d6873f] font-medium">{{ __('nav.gallery') }}</a>
                <a href="{{ route('home') }}#amenities" class="block hover:text-[#d6873f] font-medium">{{ __('nav.amenities') }}</a>
                <a href="{{ route('home') }}#location" class="block hover:text-[#d6873f] font-medium">{{ __('nav.location') }}</a>
