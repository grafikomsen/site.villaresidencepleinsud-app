        ...
        <div class="bg-white shadow-2xl p-4 md:p-8">
            ...
            <div class="text-center mb-8">
                <div class="flex items-center justify-center space-x-2 mb-4">
                    <div class="w-12 h-12 bg-gradient-to-br from-[#d6873f] to-ptimary/85 flex items-center justify-center">
            ...
            <form action="{{ route('admin.login.post') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="password" id="password" name="password" required
                        class="w-full px-4 py-3 border-2 border-gray-300 focus:border-[#d6873f] focus:outline-none transition"
                        placeholder="••••••••">
                </div>
                ...
                <!-- Submit Button -->
                <button type="submit"
                    class="w-full bg-[#d6873f] hover:to-[#d6873f]/70 text-white py-4 transition transform hover:scale-105 flex items-center justify-center">
            ...
            <div class="text-center mt-6">
                <a href="{{ route('home') }}" class="text-[#d6873f] hover:text-[#d6873f]/70 font-medium">← {{ __('admin.back_to_home') }}</a>
            </div>
        </div>
    </div>
</section>
