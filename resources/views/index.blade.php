...
<section id="hero" class="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black relative flex items-center justify-center overflow-hidden pt-20">
    ...
    <div class="relative z-10 text-center text-white max-w-4xl px-4">
        ...
        <div class="flex flex-col md:flex-row gap-4 justify-center animate-fade-in" style="animation-delay: 0.4s;">
            <a href="#reservation" class="px-4 py-2 bg-primary animate-pulse hover:bg-primary/90 font-bold text-lg transition transform hover:scale-105 inline-flex items-center justify-center">
                {{ __('hero.book_visit') }}
...
<section id="about" class="py-20 bg-[#1c1f21]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <h2 class="text-4xl md:text-5xl font-bold font-Playfair text-primary mb-4">{{ __('about.title') }}</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div class="relative group">
                <img class="relative w-full h-96 object-cover rounded-bl-[70px] shadow-2xl shadow-primary/30" src="{{ asset('frontend/images/salle-a-manger.jpg') }}" alt="Villa Exterior">
            </div>
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="bg-gray-50 p-6 border-2 border-amber-100 hover:border-primary transition rounded-bl-[20px] shadow-2xl shadow-primary/30">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="text-center p-8 bg-gradient-to-br from-amber-50 to-yellow-50 hover:shadow-lg transition  rounded-bl-[30px] shadow-2xl shadow-primary/30">
...
<section id="gallery" class="py-20 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="relative group cursor-pointer overflow-hidden  rounded-bl-[70px]  shadow-2xl shadow-primary/30 gallery-item">
...
<section id="amenities" class="py-20 bg-[#1c1f21]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <h2 class="text-4xl md:text-5xl font-Playfair font-bold text-primary mb-4">{{ __('amenities.title') }}</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="group p-8 bg-gradient-to-br from-gray-50 to-gray-100 hover:from-amber-50 hover:to-yellow-50 border border-gray-200 hover:border-primary transition cursor-pointer rounded-bl-[30px] shadow-2xl shadow-primary/30">
                <div class="text-6xl mb-4 group-hover:scale-110 transition"><i class="fa-solid text-primary {{ $amenity['icon'] }}"></i></div>
            ...
            <div class="space-y-8">
                <div class="flex items-start space-x-4">
                    <div class="flex-shrink-0">
                        <div class="flex items-center justify-center h-12 w-12 bg-primary text-white">
            ...
            <form action="{{ route('reservation.store') }}" method="POST" class="space-y-6" x-data="reservationForm()">
                ...
                <div>
                    ...
                    <input type="text" id="name" name="name" required
                        class="w-full px-4 py-3 border-2 border-gray-300 focus:border-primary focus:outline-none transition @error('name') border-red-500 @enderror"
                ...
                <div>
                    ...
                    <input type="tel" id="phone" name="phone" required
                        class="w-full px-4 py-3 border-2 border-gray-300 focus:border-primary focus:outline-none transition @error('phone') border-red-500 @enderror"
                ...
                <div>
                    ...
                    <input type="datetime-local" id="visit_date" name="visit_date" required
                        class="w-full px-4 py-3 border-2 border-gray-300 focus:border-primary focus:outline-none transition @error('visit_date') border-red-500 @enderror"
                ...
                <div>
                    ...
                    <textarea id="message" name="message" rows="4"
                        class="w-full px-4 py-3 border-2 border-gray-300 focus:border-primary focus:outline-none transition @error('message') border-red-500 @enderror"
                ...
                <!-- Submit Button -->
                <button type="submit"
                    class="w-full bg-primary hover:bg-primary/70 text-white font-bold py-3 transition transform hover:scale-105 flex items-center justify-center"
